...
export const ImportDWHDialog: React.FC<ImportDWHDialogProps> = ({
    ...
    const importDatabase = useCallback(
        async (scriptResult: string) => {
            console.log(scriptResult.charAt(0));
            ...
            const shouldRemove = new Promise<boolean>((resolve) => {
                ...
                const content = (
                    <>
                        <div className="!mb-2">
                            {t(
                                'import_dwh_dialog.override_alert.content.alert'
                            )}
                        </div>
                        {(newTablesNumber ?? 0 > 0) ? (
                        ...
                        <div className="!mt-2">
                            {t(
                                'import_dwh_dialog.override_alert.content.proceed'
                            )}
                        </div>
                    </>
                );
